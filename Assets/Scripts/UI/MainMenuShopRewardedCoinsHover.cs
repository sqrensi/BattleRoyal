...
namespace ShooterPrototype.UI
{
    ...
    public sealed class MainMenuShopRewardedCoinsHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerEnter(PointerEventData eventData)
        {
            ...
            tooltipText.text = GameAdsService.RewardedCoinsDescription;
        ...
        private void EnsureTooltip()
        {
            ...
            tooltipRoot = new GameObject("RewardedCoinsTooltip");
