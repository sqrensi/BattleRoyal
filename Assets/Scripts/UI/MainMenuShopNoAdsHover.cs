...
namespace ShooterPrototype.UI
{
    ...
    public sealed class MainMenuShopNoAdsHover : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private string BuildTooltipText()
        {
            ...
            return "Отключение рекламы на 30 дней";
        }
        ...
        private void EnsureTooltip()
        {
            ...
            tooltipRoot = new GameObject("NoAdsTooltip");
