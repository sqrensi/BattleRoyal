...
namespace ShooterPrototype.UI
{
    ...
    public sealed class CombatHudController : MonoBehaviour
    {
        ...
        private void ShowKillBanner(string victimNickname)
        {
            ...
            killBannerText.text = $"Вы убили игрока \"{victim}\"";
        ...
        public void ShowDuelKillBanner(string victimNickname)
        {
            ShowKillBanner(victimNickname);
        }

        public void ShowDuelDeathBanner(string killerNickname)
        {
            ShowDeathBanner(killerNickname);
        }
        ...
        private void ShowDeathBanner(string killerNickname, bool fromZone = false)
        {
            ...
            else
            {
                ...
                killBannerText.text = $"Вас убил игрок \"{killer}\"";
            }
